const data = {
    ...
    "slider": {
        "title": "Humaya",
        "description": "Los productos HUMAYA son elaborados desde hace más de 50 años fiel a las tradiciones familiares y sabores caseros, acompañándote en los momentos más importantes de la vida",
        "link": "#about-us",
        "image_name": "static\/images\/slider.png"
    },
    "quality": {
    ...
    "products": {
        ...
        "catalogue":{
            "primary":[
                {
                    "name": "Dulce de leche tradicional","description": "Elaboración artesanal de principio a fin, con un sabor intenso, receta tradicional.",
                ...
                {
                    "name": "Dulce de leche sin azúcar","description": "Elaboración artesanal para cuidar tu silueta sin renunciar a nada endulzado naturalmente con stevia.",
                ...
                },
                {
                    ...
                    "description": "Elaboración artesanal para el capricho dulce, combinación de dulce de leche, chocolate y pasta de avellanas. Una delicia única.",
            ...
            "processed":[
                {
                    ...
                    "description": "Alfajores de dulce con coco rallado, relleno con 2cm de pura dulzura. Pudiendo elegir entre dulce de leche tradicional, light o choconutt.",
    ...
    "about_us": {
        ...
        "description": "Somos una empresa familiar dedicada desde hace más de 50 años a la elaboración de productos de calidad con sabor a casero.",
        "clients":[
            {
                "name": "Paulina Cocina",
    ...
    "contact": {
        "title": "Contáctanos",
        "description": "Déjanos tu consulta y nuestro personal se pondrá en contacto a la brevedad:"
    },
    "shops": {
    ...
    "recipes": {
        "title": "Recetas",
        "description": "Descubre las mejores recetas de dulce de leche de la mano de Paulina Cocina.",
        "link": "https://www.paulinacocina.net/ingrediente/dulce-de-leche",
        "recipes_list": [
            {
                "name": "Alfajores marplatenses",
                "description": "Una deliciosa opción para acompañar las meriendas, ese antojo de media noche o compartir con amigos",
            ...
            },
            {
                ...
                "description": "La combinación más clásica, simple y deliciosa del mundo, que no falla nunca.",
            ...
            {
                "name": "Torta Marquise",
                "description": "Un postre hermoso de la cocina francesa, con una textura y un sabor único que solo una torta de chocolate puede regalarnos.",
